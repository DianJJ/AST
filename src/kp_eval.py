...
class KeyPointEvaluator:
    ...
    def predict(self, imgs, kps):
        meshes,_, (R, T),slcys, bkgs = self.model.predict_mesh_pose_slcy_bkg(imgs)
    ...
    def transfer_keypoints(self, kp_src, R_src, T_src, mesh_src, R_tgt, T_tgt, mesh_tgt):
        ...
        # Project vertex 3D positions fr
        # m source mesh to image space
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--n_pairs', nargs='?', default=100, type=int, help='number of pair to eval')
